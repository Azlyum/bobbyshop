...
export function ShowcaseCard({ build, onPreviewStart, onPreviewEnd, onOpen }: ShowcaseCardProps) {
  return (
    <article className="showcase-shell group relative flex h-full flex-col overflow-hidden rounded-[2rem] p-6 transition hover:-translate-y-1 hover:border-lime-300/30">
